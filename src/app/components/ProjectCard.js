        ...
        <Draggable draggableId={props._id} index={props.index}>
            {(provided) => (
                ...
                <div className="relative bg-red-500">
                    ...
                    :    
                    <div ref={clickRef}  className="flex flex-row justify-between bg-secondary hover:cursor-pointer h-15vh border-2 border-dashed  border-black  ml-3 mr-3  mt-2 rounded-lg  p-2">
